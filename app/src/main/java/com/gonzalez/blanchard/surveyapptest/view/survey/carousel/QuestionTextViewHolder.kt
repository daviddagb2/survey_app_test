...
import com.gonzalez.blanchard.surveyapptest.databinding.ItemQuestionTextBinding

class QuestionTextViewHolder(view: View, private val onClickListener: (QueryItemBO) -> Unit) : RecyclerView.ViewHolder(view) {

    private val binding = ItemQuestionTextBinding.bind(view)
