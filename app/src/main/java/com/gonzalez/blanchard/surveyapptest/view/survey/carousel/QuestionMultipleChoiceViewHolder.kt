...
import com.gonzalez.blanchard.surveyapptest.databinding.ItemQuestionMultiChoiceBinding

class QuestionMultipleChoiceViewHolder(view: View, private val onClickListener: (QueryItemBO) -> Unit) : RecyclerView.ViewHolder(view) {

    private val binding = ItemQuestionMultiChoiceBinding.bind(view)
